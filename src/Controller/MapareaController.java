            ...
            public void changed(ObservableValue<? extends Number> ov,
                ...
                markers= new ArrayList<Marker>();
                    ...
                    for (int i=0;i<espaces.size();i++){
                        ...
                        LatLong position = new LatLong(espaces.get(i).getLat()+0.889932,espaces.get(i).getLongi()+0.200000); 
                                                     
                         Marker marker = new Marker(new MarkerOptions().position(position).title(espaces.get(i).getTitre()).animation(Animation.DROP)); 
                         map.addMarker(marker);
                         markers.add(marker);
                         
                        InfoWindowOptions infoWindowOptions = new InfoWindowOptions();
                        String adresse = "<h2 style='text-align: center'>"+espaces.get(i).getTitre()+"</span>"+espaces.get(i).getAdresse()+"</span>"; 

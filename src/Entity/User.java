...
public class User {
    ...
    public String toString() {
        return "User{" + "id=" + id + ", username=" + username + ", email=" + email + ", enabled=" + enabled + ", salt=" + salt + ", lastLogin=" + lastLogin + ", nom=" + nom + ", prenom=" + prenom + ", dateNaissance=" + dateNaissance + ", genre=" + genre + ", pays=" + pays + ", region=" + region + ", ville=" + ville + ", tel=" + tel + ", placeNaiss=" + placeNaiss + ", religion=" + religion + ", apropos=" + apropos + ", facebook=" + facebook + ", twitter=" + twitter + ", instagram=" + instagram + ", image=" + image + ", updatedAt=" + updatedAt + ", occupation=" + occupation + '}';
    }
